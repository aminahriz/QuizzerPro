 ...
 * @author timbi
 */
public class CreateTF extends javax.swing.JFrame {
    ...
    private void finishVarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_finishVarActionPerformed
        ...
        TrueFalse qtf = new TrueFalse("t/f", question);
        Questions.questions.add(qtf);
        Questions.questions.remove(qtf);
        TrueFalse atf = new TrueFalse("t/f", question, answer);
        Questions.answers.add(atf);
        Questions.answers.remove(atf);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateTF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
